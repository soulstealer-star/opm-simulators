...
#include <opm/simulators/flow/python/PyFlowSimulator.hpp>
...
PyFlowSimulator::
PyFlowSimulator( const std::string &deck_filename)
...
::Opm::FlowMainEbos<typename PyFlowSimulator::TypeTag>&
PyFlowSimulator::
...
PyFluidState<typename PyFlowSimulator::TypeTag>&
PyFlowSimulator::
getFluidState() const
{
...
PyMaterialState<typename Opm::Pybind::PyFlowSimulator::TypeTag>&
PyFlowSimulator::
...
{
    py::class_<PyFlowSimulator>(m, "FlowSimulator")
        ...
        .def("advance", &PyFlowSimulator::advance, py::arg("report_step"))
        .def("current_step", &PyFlowSimulator::currentStep)
        .def("get_cell_volumes", &PyFlowSimulator::getCellVolumes,
            py::return_value_policy::copy)
        .def("get_dt", &PyFlowSimulator::getDT)
        .def("get_fluidstate_variable", &PyFlowSimulator::getFluidStateVariable,
            py::return_value_policy::copy, py::arg("name"))
        .def("get_porosity", &PyFlowSimulator::getPorosity,
            py::return_value_policy::copy)
        .def("get_primary_variable_meaning", &PyFlowSimulator::getPrimaryVarMeaning,
            py::return_value_policy::copy, py::arg("variable"))
        .def("get_primary_variable_meaning_map", &PyFlowSimulator::getPrimaryVarMeaningMap,
            py::return_value_policy::copy, py::arg("variable"))
        .def("get_primary_variable", &PyFlowSimulator::getPrimaryVariable,
            py::return_value_policy::copy, py::arg("variable"))
        .def("run", &PyFlowSimulator::run)
        .def("set_porosity", &PyFlowSimulator::setPorosity)
        .def("set_primary_variable", &PyFlowSimulator::setPrimaryVariable,
            py::arg("idx_name"), py::arg("value"))
        .def("step", &PyFlowSimulator::step)
        .def("step_cleanup", &PyFlowSimulator::stepCleanup)
        .def("step_init", &PyFlowSimulator::stepInit);
}
